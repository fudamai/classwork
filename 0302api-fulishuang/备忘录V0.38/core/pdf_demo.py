...
fonturl = os.path.join(BASE_DIR, 'core', 'SimSun.ttf')
pdfmetrics.registerFont(TTFont('simsun', fonturl))  # 导入字体文件，使用Windows字体或下载好的"simsun.ttf"，用来显示中文
output_path = os.path.join(BASE_DIR, 'db', 'out1.pdf')
...
class ExportPDF:
    ...
    """
    def __init__(self, result_list, output_path=output_path, is_custom_color=False, color=(0.77, 0.77, 0.77), font_size=8, offset_x=5, offset_y=5):
