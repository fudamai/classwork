...
$(function($) {
    $('#btn-edit-topic').click(function() {
        ...
        if($(this).text() == '编辑'){
            ...
            let input = '<input id="topic-text-input" class="mb-0  lh-100" type="text" value="' + input_text + ' ">'
            ...
            $.post("/bbs/", {
                ...
                console.log('修改成功1');
                let h6 = '<h6  id="topic-text" class="mb-0 text-white lh-100">' + $('#topic-text-input').val() + '</h6>'
